...
function MapboxCircle(map, center, radius, options) {
    ...
    this._updateSteps = function(zoom) {
    ...
    this._updateCircle = function() {
        ...
        if (this.statusEl) {
            this.statusEl.innerHTML = ('Center: ' + this.getCenter() + ' / Radius: ' + Math.trunc(this.getRadius()) +
