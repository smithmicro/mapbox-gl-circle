...
class MapboxCircle {
    ...
    setRadius(newRadius) {
        ...
        if (this._lastRadius !== newRadius && this.radius === newRadius) {
            this._eventEmitter.emit('radiuschanged', this);
        }
        return this;
    }
    ...
    /**
     * Get southwestern and northeastern geodesic bounds of the circle.
     * @return {{sw: {lat: number, lng: number}, ne: {lat: number, lng: number}}}
     * @public
     */
    getBounds() {
