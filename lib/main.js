...
class MapboxCircle {
    ...
    set center(newCenter) {
        this._center[0] = newCenter[0];
        this._center[1] = newCenter[1];
        this._updateCircle();
        this._animate();
    }

    /** @return {[number,number]} Center `[lng, lat]` coordinates. */
    get center() {
        return this._center;
    }
    ...
    constructor(center, radius, options) {
        ...
        /** @const {[number,number]} */ this._lastCenter = [center[0], center[1]];
        /** @const {[number,number]} */ this._center = [center[0], center[1]];
    ...
    _updateCircle() {
        ...
        if (this.options.statusEl) {
            this.options.statusEl.innerHTML = ('Center: LngLat(' + this._center + ') / Radius: ' + this._radius +
     ...
     */
    _onCenterChanged() {
        this._lastCenter[0] = this.center[0];
        this._lastCenter[1] = this.center[1];
    }
