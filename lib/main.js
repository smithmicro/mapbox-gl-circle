...
class MapboxCircle {
    ...
    */
    ...
    onCenterHandleMouseUp() {
        this.map.setPaintProperty('circle-center-handle', 'circle-color', '#fb6a4a');
    ...
    onCenterHandleMouseDown() {
        ...
        this.map.setPaintProperty('circle-center-handle', 'circle-color', '#a50f15');
    ...
    onRadiusHandleMouseUp() {
        this.map.setPaintProperty('circle-radius-handles', 'circle-color', 'white');
        this.map.dragPan.enable();
    ...
    onRadiusHandleMouseDown() {
        this.map.dragPan.disable();
        this.map.setPaintProperty('circle-radius-handles', 'circle-color', '#a50f15');
    ...
    onMouseMove(event) {
        ...
        if (pointFeatures.length) {
            ...
            this.map.once('mousedown', this.onRadiusHandleMouseDown);
        } else if (circleFeatures.length) {
            this.map.getCanvas().style.cursor = 'pointer';
            this.map.once('mousedown', this.onCenterHandleMouseDown);
        }
    }
